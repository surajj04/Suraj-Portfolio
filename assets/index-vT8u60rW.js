...
function Id (e, t, n) {
  ...
  return { $$typeof: br, type: e, key: o, ref: s, props: i, _owner: _l.current }
}
function Nm (e, t) {
  return {
    $$typeof: br,
...
function pu (e) {
  if ((e = Yr(e))) {
    ...
    var t = e.stateNode
    t && ((t = Po(t)), Is(e.stateNode, e.type, t))
  }
}
function nf (e) {
...
function uf (e) {
  return (e = tg(e)), e !== null ? cf(e) : null
}
function cf (e) {
...
var df = Me.unstable_scheduleCallback,
  gu = Me.unstable_cancelCallback,
  ng = Me.unstable_shouldYield,
  rg = Me.unstable_requestPaint,
  Z = Me.unstable_now,
  ig = Me.unstable_getCurrentPriorityLevel,
  Hl = Me.unstable_ImmediatePriority,
  ff = Me.unstable_UserBlockingPriority,
  $i = Me.unstable_NormalPriority,
  og = Me.unstable_LowPriority,
  hf = Me.unstable_IdlePriority,
  vo = null,
  Ze = null
function sg (e) {
...
var Ke = Math.clz32 ? Math.clz32 : ug,
  lg = Math.log,
  ag = Math.LN2
function ug (e) {
...
function Ei (e) {
  ...
  for (var t = e.targetContainers; 0 < t.length; ) {
    ...
    } else return (t = Yr(n)), t !== null && bl(t), (e.blockedOn = n), !1
    t.shift()
  }
  return !0
}
...
function er (e, t) {
  e.blockedOn === t &&
    ((e.blockedOn = null),
    $s ||
      (($s = !0), Me.unstable_scheduleCallback(Me.unstable_NormalPriority, mg)))
}
function Mr (e) {
  function t (i) {
    return er(i, e)
...
function Gl (e, t, n, r) {
  if (Hi) {
    ...
    else if ((yu(e, r), t & 4 && -1 < hg.indexOf(e))) {
      for (; i !== null; ) {
        var o = Yr(i)
        if (
          (o !== null && gf(o),
...
var Gn = {
  ...
  xo = G({}, Qr, {
    ...
    movementX: function (e) {
      return 'movementX' in e
        ...
        : (e !== tr &&
            (tr && e.type === 'mousemove'
              ? ((bo = e.screenX - tr.screenX), (Go = e.screenY - tr.screenY))
              : (Go = bo = 0),
            (tr = e)),
          bo)
    },
  ...
  wu = De(xo),
  xg = G({}, xo, { dataTransfer: 0 }),
  wg = De(xg),
  Sg = G({}, Qr, { relatedTarget: 0 }),
  Qo = De(Sg),
  Pg = G({}, Gn, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }),
  kg = De(Pg),
  Tg = G({}, Gn, {
...
var Lg = G({}, Qr, {
  ...
  _g = De(Rg),
  Fg = G({}, Gn, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }),
  Og = De(Fg),
  Ig = G({}, xo, {
    deltaX: function (e) {
...
var Ug = dt && 'TextEvent' in window && !pr,
  kf = dt && (!Zl || (pr && 8 < pr && 11 >= pr)),
  ku = ' ',
  Tu = !1
function Tf (e, t) {
  switch (e) {
...
function $g (e, t) {
  switch (e) {
    case 'compositionend':
      return Cf(t)
    case 'keypress':
      return t.which !== 32 ? null : ((Tu = !0), ku)
    case 'textInput':
      return (e = t.data), e === ku && Tu ? null : e
    default:
      return null
  }
}
...
function Au () {
  mr && (mr.detachEvent('onpropertychange', Vf), (Nr = mr = null))
}
function Vf (e) {
  if (e.propertyName === 'value' && wo(Nr)) {
    var t = []
    Ef(t, Nr, e, Wl(e)), lf(Kg, t)
  }
}
function Gg (e, t, n) {
  e === 'focusin'
    ? (Au(), (mr = t), (Nr = n), mr.attachEvent('onpropertychange', Vf))
    : e === 'focusout' && Au()
}
function Qg (e) {
...
var Ge = typeof Object.is == 'function' ? Object.is : Zg
function Lr (e, t) {
  if (Ge(e, t)) return !0
...
var qg = dt && 'documentMode' in document && 11 >= document.documentMode,
  gn = null,
  Hs = null,
  gr = null,
  Ks = !1
...
for (var Jo = 0; Jo < Lu.length; Jo++) {
  var qo = Lu[Jo],
    e0 = qo.toLowerCase(),
    t0 = qo[0].toUpperCase() + qo.slice(1)
  It(e0, 'on' + t0)
}
...
var ur =
  ...
  n0 = new Set('cancel close invalid load scroll toggle'.split(' ').concat(ur))
function Du (e, t, n) {
  ...
  if (!e[fi]) {
    ;(e[fi] = !0),
      Hd.forEach(function (n) {
        n !== 'selectionchange' && (n0.has(n) || es(n, !1, e), es(n, !0, e))
      })
      ...
      T &&
        (kf &&
          ...
          (mn || T !== 'onCompositionStart'
            ? T === 'onCompositionEnd' && mn && (A = Pf())
            : ((kt = c),
              (Ql = 'value' in kt ? kt.value : kt.textContent),
              (mn = !0))),
        (C = bi(u, T)),
        0 < C.length &&
...
function hi (e, t, n) {
  if (((t = Ru(t)), Ru(e) !== t && n)) throw Error(P(425))
}
function Gi () {}
var bs = null,
  Gs = null
...
var Ys = typeof setTimeout == 'function' ? setTimeout : void 0,
  ...
  s0 =
    typeof queueMicrotask == 'function'
      ...
      : typeof _u < 'u'
      ? function (e) {
          return _u.resolve(null).then(e).catch(l0)
        }
      : Ys
function l0 (e) {
  setTimeout(function () {
...
var Qn = Math.random().toString(36).slice(2),
  ...
  Xs = '__reactEvents$' + Qn,
  a0 = '__reactListeners$' + Qn,
  u0 = '__reactHandles$' + Qn
function Zt (e) {
  var t = e[Xe]
  if (t) return t
...
function zf (e, t, n) {
  ...
  if (((t = t.childContextTypes), typeof r.getChildContext != 'function'))
    return n
  r = r.getChildContext()
  for (var i in r) if (!(i in t)) throw Error(P(108, Gm(e) || 'Unknown', i))
  return G({}, n, r)
}
function Yi (e) {
  return (
...
function Hf (e) {
  ...
  function y (p, h, m, x) {
    for (
      ...
      e && A && N.alternate === null && t(p, A),
        (h = o(N, h, T)),
        C === null ? (S = N) : (C.sibling = N),
        (C = N),
        (A = _)
    }
    if (T === m.length) return n(p, A), W && Gt(p, T), S
    if (A === null) {
      for (; T < m.length; T++)
        (A = d(p, m[T], x)),
          A !== null &&
  ...
  function v (p, h, m, x) {
    ...
    for (
      var C = (S = null), A = h, T = (h = 0), _ = null, N = m.next();
      A !== null && !N.done;
      T++, N = m.next()
    ) {
      A.index > T ? ((_ = A), (A = null)) : (_ = A.sibling)
      var ne = f(p, A, N.value, x)
      if (ne === null) {
        A === null && (A = _)
        break
      }
    ...
    if (N.done) return n(p, A), W && Gt(p, T), S
    if (A === null) {
      for (; !N.done; T++, N = m.next())
        (N = d(p, N.value, x)),
          N !== null &&
            ((h = o(N, h, T)), C === null ? (S = N) : (C.sibling = N), (C = N))
      return W && Gt(p, T), S
    }
    for (A = r(p, A); !N.done; T++, N = m.next())
      (N = g(A, p, T, N.value, x)),
        N !== null &&
          (e && N.alternate !== null && A.delete(N.key === null ? T : N.key),
          (h = o(N, h, T)),
          C === null ? (S = N) : (C.sibling = N),
          (C = N))
    return (
    ...
    if (
      ...
      switch (m.$$typeof) {
        ...
        case hn:
          ...
          return s(p)
        case xt:
          return (C = m._init), k(p, h, C(m._payload), x)
      }
...
function da (e, t, n, r, i, o) {
  if (
    ...
    (t.updateQueue = null),
    (t.lanes = 0),
    (Ni.current = e === null || e.memoizedState === null ? g0 : y0),
    (e = n(r, i)),
    yr)
  ) {
    o = 0
    do {
      if (((yr = !1), (Or = 0), 25 <= o)) throw Error(P(301))
      ;(o += 1),
        (ie = ee = null),
        (t.updateQueue = null),
        (Ni.current = v0),
...
function ss (e) {
  ...
  if (((e = n.interleaved), e !== null)) {
    i = e
    do (o = i.lane), (b.lanes |= o), (an |= o), (i = i.next)
    while (i !== e)
...
function uh (e, t, n) {
  return ln & 21
    ? (Ge(n, t) || ((n = pf()), (b.lanes |= n), (an |= n), (e.baseState = !0)),
      t)
...
function m0 (e, t, n) {
  ...
  if (dh(e)) fh(t, i)
    ...
    ;(n = bf(e, t, i, r)),
      n !== null && ((i = ve()), be(n, e, r, i), hh(n, t, r))
  }
}
function dh (e) {
  var t = e.alternate
...
var ro = {
  ...
  g0 = {
    ...
    useTransition: function () {
      var e = Hu(!1),
        t = e[0]
      return (e = h0.bind(null, e[1])), (Ye().memoizedState = e), [t, e]
    },
...
function S0 (e, t, n, r, i, o, s) {
  if (n)
    return t.flags & 256
      ? ((t.flags &= -257), (r = as(Error(P(422)))), gi(e, t, s, r))
      : t.memoizedState !== null
  ...
  if (i.data === '$!') {
    ...
    return (r = l), (o = Error(P(419))), (r = as(o, r, void 0)), gi(e, t, s, r)
  }
  if (((l = (s & e.childLanes) !== 0), Pe || l)) {
    if (((r = oe), r !== null)) {
      ...
      ;(i = i & (r.suspendedLanes | s) ? 0 : i),
        i !== 0 &&
          i !== o.retryLane &&
          ((o.retryLane = i), ht(e, i), be(r, e, i, -1))
    }
    return Sa(), (r = as(Error(P(421)))), gi(e, t, s, r)
  }
  return i.data === '$?'
    ? ((t.flags |= 128),
      (t.child = e.child),
...
function E0 (e, t) {
  ...
  for (Gs = { focusedElem: e, selectionRange: n }, Hi = !1, V = t; V !== null; )
...
function Eh (e) {
  ...
  t !== null && ((e.alternate = null), Eh(t)),
    ...
    e.tag === 5 &&
      ((t = e.stateNode),
      t !== null &&
        (delete t[Xe], delete t[Rr], delete t[Xs], delete t[a0], delete t[u0])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
...
function Mh (e, t) {
  ...
  switch (e.tag) {
    ...
    case 15:
      ...
      break
    case 1:
      Ue(t, e), Qe(e), r & 512 && n !== null && kn(n, n.return)
      break
    case 5:
      if (
        (Ue(t, e),
          ...
          for (V = i; V !== null; )
            (s = V),
              ...
              s.tag === 22 && s.memoizedState !== null
                ...
                ? ((a.return = s), (V = a))
                : lc(i)
        for (; o !== null; ) (V = o), Nh(o), (o = o.sibling)
        ;(V = i), (yi = l), (he = u)
      }
      oc(e)
    } else
...
function be (e, t, n, r) {
  if (50 < wr) throw ((wr = 0), (pl = null), Error(P(185)))
  Gr(e, n, r),
    (!(F & 2) || e !== oe) &&
      (e === oe && (!(F & 2) && (Ao |= n), te === 4 && Pt(e, ae)),
      Ce(e, r),
      n === 1 && F === 0 && !(t.mode & 1) && (($n = Z() + 500), ko && Bt()))
}
function Ce (e, t) {
  ...
  if (r === 0)
    ...
    if ((n != null && gu(n), t === 1))
      e.tag === 0 ? c0(ac.bind(null, e)) : Bf(ac.bind(null, e)),
        s0(function () {
          !(F & 6) && Bt()
        }),
        (n = null)
...
function Lh (e, t) {
  if (((ji = -1), (Ri = 0), F & 6)) throw Error(P(327))
  var n = e.callbackNode
  ...
  if (t !== 0) {
    if (
      ...
      throw ((n = Br), tn(e, 0), Pt(e, r), Ce(e, Z()), n)
    if (t === 6) Pt(e, r)
    else {
      if (
      ...
      switch (((e.finishedWork = i), (e.finishedLanes = r), t)) {
        ...
        case 3:
          if (
            (Pt(e, r), (r & 130023424) === r && ((t = va + 500 - Z()), 10 < t))
          ) {
            if (Wi(e, 0) !== 0) break
...
function ac (e) {
  ...
  if (n === 1) throw ((n = Br), tn(e, 0), Pt(e, t), Ce(e, Z()), n)
...
function Sa () {
  ;(te === 0 || te === 3 || te === 2) && (te = 4),
    oe === null || (!(an & 268435455) && !(Ao & 268435455)) || Pt(oe, ae)
}
function lo (e, t) {
  var n = F
  F |= 2
  ...
  while (!0)
  if ((ra(), (F = n), (io.current = r), J !== null)) throw Error(P(261))
...
function Qt (e, t, n) {
  var r = I,
    i = Ie.transition
  try {
    ;(Ie.transition = null), (I = 1), D0(e, t, n, r)
  } finally {
    ;(Ie.transition = i), (I = r)
  }
  return null
  ...
  if (Tt !== null) {
    ...
    try {
      if (((Ie.transition = null), (I = 16 > e ? 16 : e), Tt === null))
        ...
        if (((e = Tt), (Tt = null), (so = 0), F & 6)) throw Error(P(331))
        var i = F
...
function Fh (e, t) {
  t === 0 &&
    (e.mode & 1
      ...
      : (t = 1))
  var n = ve()
  ;(e = ht(e, t)), e !== null && (Gr(e, t, n), Ce(e, n))
}
function R0 (e) {
  var t = e.memoizedState,
    n = 0
...
Oh = function (e, t, n) {
  if (e !== null)
    if (e.memoizedProps !== t.pendingProps || ke.current) Pe = !0
      ...
      if (!(e.lanes & n) && !(t.flags & 128)) return (Pe = !1), P0(e, t, n)
      Pe = !!(e.flags & 131072)
    }
  else (Pe = !1), W && t.flags & 1048576 && Uf(t, Zi, t.index)
  switch (((t.lanes = 0), t.tag)) {
    ...
    case 3:
      e: {
        if ((wh(t), e === null)) throw Error(P(387))
        ;(r = t.pendingProps),
          (o = t.memoizedState),
          (i = o.element),
          Gf(e, t),
        ...
        if (((r = s.element), o.isDehydrated))
          if (
            ...
            ;(i = Un(Error(P(423)), t)), (t = ec(e, t, r, n, i))
            break e
          } else if (r !== i) {
            ;(i = Un(Error(P(424)), t)), (t = ec(e, t, r, n, i))
            break e
          } else
            for (
...
No.prototype.render = Ca.prototype.render = function (e) {
  var t = this._internalRoot
  if (t === null) throw Error(P(409))
  Mo(e, t, null, null)
}
No.prototype.unmount = Ca.prototype.unmount = function () {
...
of = xa
sf = un
var $0 = { usingClientEntryPoint: !1, Events: [Yr, vn, Po, nf, rf, xa] },
  ir = {
  ...
  W0 = {
    ...
    findFiberByHostInstance: ir.findFiberByHostInstance || B0,
...
const Va = [
  ...
  lt = e => e * 1e3,
  at = e => e / 1e3,
  G0 = { type: 'spring', stiffness: 500, damping: 25, restSpeed: 10 },
  Q0 = e => ({
    type: 'spring',
    stiffness: 550,
  ...
  Y0 = { type: 'keyframes', duration: 0.8 },
  X0 = { type: 'keyframes', ease: [0.25, 0.1, 0.35, 1], duration: 0.3 },
  Z0 = (e, { keyframes: t }) =>
    t.length > 2 ? Y0 : Ut.has(e) ? (e.startsWith('scale') ? Q0(t[1]) : G0) : X0
function Na (e, t) {
  return e ? e[t] || e.default || e : void 0
}
const J0 = { skipAnimations: !1, useManualTiming: !1 },
  q0 = e => e !== null
...
function iy (e, t, n, r, i) {
  let o,
    s,
    l = 0
  do (s = t + (n - t) / 2), (o = bh(s, r, i) - e), o > 0 ? (n = s) : (t = s)
...
const Gh = e => t => t <= 0.5 ? e(2 * t) / 2 : (2 - e(2 * (1 - t))) / 2,
  Qh = e => t => 1 - e(1 - t),
...
function ky (e) {
  ...
  return (
    ...
    (((t = e.match(_a)) === null || t === void 0 ? void 0 : t.length) || 0) +
      (((n = e.match(Py)) === null || n === void 0 ? void 0 : n.length) || 0) >
      0
  )
}
const cp = 'number',
...
const Ot = {
  ...
  My = new Set(['brightness', 'contrast', 'saturate', 'opacity'])
function Ny (e) {
...
function pp (e, t) {
  let n = Ia(e)
  return (
    n !== Pl && (n = Ot), n.getAnimatableNone ? n.getAnimatableNone(t) : void 0
  )
}
...
const et = {
    now: () => (
      Fi === void 0 &&
        et.set(
          le.isProcessing || J0.useManualTiming
            ? le.timestamp
            : performance.now()
        ),
      Fi
...
function Qy (e, t, n) {
  let r = n
  for (let i = 1; i < Gy; i++) r = r - e(r) / t(r)
  return r
}
function kl (e, t) {
...
function xp ({ keyframes: e, restDelta: t, restSpeed: n, ...r }) {
  ...
  if (y < 1) {
    const m = kl(k, y)
    h = x => {
      const S = Math.exp(-y * k * x)
      return (
        o - S * (((g + y * k * v) / m) * Math.sin(m * x) + v * Math.cos(m * x))
      )
    }
    ...
    h = x => {
      const S = Math.exp(-y * k * x),
        C = Math.min(m * x, 300)
      return (
        o - (S * ((g + y * k * v) * Math.sinh(C) + m * v * Math.cosh(C))) / m
      )
    }
  }
  return {
...
function kc ({
  ...
  const h = T => -v * Math.exp(-T / r),
    ...
    x = T => {
      const _ = h(T),
        N = m(T)
      ;(f.done = Math.abs(_) <= u), (f.value = f.done ? p : N)
    }
  let S, C
  const A = T => {
    g(f.value) &&
...
const yv = e => {
  ...
  vv = { decay: kc, inertia: kc, tween: co, keyframes: co, spring: xp },
  xv = e => e / 100
class $a extends gp {
  constructor (t) {
    super(t),
...
const Pv = { linearEasing: void 0 }
function kv (e, t) {
  const n = Wa(e)
  return () => {
    var r
    return (r = Pv[t]) !== null && r !== void 0 ? r : n()
  }
}
const fo = kv(() => {
  try {
...
class Nc extends gp {
  ...
  initPlayback (t, n) {
    ...
    if (
      (typeof s == 'string' && fo() && Mv(s) && (s = Ep[s]), Av(this.options))
    ) {
      const {
          onComplete: f,
          onUpdate: g,
    ...
    return (
      ...
      this.pendingTimeline
        ? (Mc(d, this.pendingTimeline), (this.pendingTimeline = void 0))
        : (d.onfinish = () => {
...
const Nv = Wa(() => window.ScrollTimeline !== void 0)
class Lv {
  constructor (t) {
  ...
  attachTimeline (t, n) {
    const r = this.animations.map(i =>
      Nv() && i.attachTimeline ? i.attachTimeline(t) : n(i)
    )
    return () => {
      r.forEach((i, o) => {
...
const Ha =
    ...
    s => {
      ...
      return !o && Nc.supports(c) ? new Nc(c) : new $a(c)
    },
...
class Ga {
  ...
  add (t) {
    return Ka(this.subscriptions, t), () => ba(this.subscriptions, t)
  }
  notify (t, n, r) {
...
class Fv {
  ...
  on (t, n) {
    this.events[t] || (this.events[t] = new Ga())
...
function Al (e, t, n = {}) {
  ...
  const s = i ? () => Promise.all(Np(e, i, n)) : () => Promise.resolve(),
    l =
...
function Yv (e) {
  ...
  function s (a) {
    ...
    for (let k = 0; k < Gv; k++) {
      ...
      let T = A || (p === a && h.isActive && !C && x) || (k > y && x),
        _ = !1
      ...
      ;(h.prevProp = m),
        ...
        T &&
          (!(C && A) || _) &&
          d.push(...N.map(q => ({ animation: q, options: { type: p } })))
    }
    if (f.size) {
      const k = {}
      f.forEach(p => {
...
function x1 (e, t, n, r = !1) {
  ...
  for (let l = 0; l < i; l++) {
    ...
    ;(a && a.props.style && a.props.style.display === 'contents') ||
      ...
      r && Yt(o.latestValues) && Mn(e, o.latestValues))
  }
...
const { schedule: Ya, cancel: Mw } = Kh(queueMicrotask, !1)
class M1 extends D.Component {
  componentDidMount () {
    const {
        visualElement: t,
        layoutGroup: n,
...
function Gp (e) {
  ...
  return w.jsx(M1, {
    ...e,
    layoutGroup: r,
    switchLayoutGroup: D.useContext(bp),
    isPresent: t,
    safeToRemove: n
  })
}
...
function qp ({
  ...
  return class {
    ...
    addEventListener (s, l) {
      return (
        this.eventHandlers.has(s) || this.eventHandlers.set(s, new Ga()),
          ...
          this.addEventListener(
            ...
            ({
              ...
              if (
                ...
                const x = { ...Na(v, 'layout'), onPlay: k, onComplete: p }
    ...
    getProjectionStyles (s) {
      ...
      for (const v in mo) {
        ...
        const { correct: k, applyTo: p } = mo[v],
...
const cx = qp({
  ...
  dx = {
    pan: { Feature: C1 },
    drag: { Feature: T1, ProjectionNode: tm, MeasureLayout: Gp }
  }
function wd (e, t) {
...
const Px = {
  ...
  kx = { layout: { ProjectionNode: tm, MeasureLayout: Gp } },
  rm = D.createContext({
...
function Io (e) {
  return Ur(e.animate) || Ma.some(t => $r(e[t]))
}
function sm (e) {
...
const Pd = {
  ...
  Kn = {}
for (const e in Pd) Kn[e] = { isEnabled: t => Pd[e].some(n => !!t[n]) }
function Nx (e) {
...
class aw {
  ...
  on (t, n) {
    return this.events[t] || (this.events[t] = new Ga()), this.events[t].add(n)
  }
  notify (t, ...n) {
...
const fw = (e, t) =>
              ...
              w.jsxs(O.div, {
                ...
                children: [
                  ...
                  w.jsx(O.p, {
                    ...
                    variants: ki,
                    children:
                      'Python Backend Developer Skilled in building web applications with Python, Django, and FastAPI. Experience developing REST APIs, working with databases, and processing data using Pandas. Strong foundation in OOP principles and writing clean code. Passionate about creating efficient backend systems and eager to learn and grow as a developer.'
                  }),
                  w.jsx(O.div, {
                    variants: ki,
                    children: w.jsxs('a', {
                      href: 'https://drive.google.com/file/d/1t9-A0ksa7GbWcZoyjPofViwz961_nhWw/view?usp=drive_link',
                      target: '_blank',
          ...
          children: [
            w.jsxs(O.div, {
              ...
              children: [
                w.jsxs('h2', {
                  className:
                    'text-4xl md:text-5xl font-bold text-stone-100 mb-4',
                  children: [
                    'Technical ',
                    w.jsx('span', {
              ...
              children: e.map((n, r) =>
                w.jsxs(
                  O.div,
                  {
                    ...
                    children: [
                      w.jsxs(O.h3, {
                        className: 'text-2xl font-bold mb-6 text-stone-100',
                        variants: {
                        ...
                        children: [
                          ...
                          w.jsx('div', {
                            className:
                              'w-16 h-1 bg-indigo-500 rounded-full mt-2'
                          })
                        ]
                      }),
                      w.jsx('div', {
                        ...
                        children: n.items.map((i, o) =>
                          w.jsxs(
                            O.div,
                            {
                              variants: vw,
                              whileHover: 'hover',
                              className: `flex flex-col items-center p-4 rounded-lg ${i.bg} border border-stone-800 backdrop-blur-sm hover:shadow-lg hover:shadow-indigo-500/10 transition-all`,
                              children: [
                                w.jsx(O.div, {
                                  initial: 'initial',
                                  animate: 'animate',
                                  variants: gw(o),
                                  className: `text-4xl ${i.color} mb-3`,
                                  children: w.jsx('i', { className: i.icon })
                                }),
                                w.jsx('span', {
                                  className:
                                    'text-sm font-medium text-stone-300 text-center',
                                  children: i.name
                                })
                              ]
                            },
            ...
            w.jsxs(O.div, {
              ...
              viewport: { once: !0 },
              className:
                'mt-16 bg-stone-900/50 backdrop-blur-sm rounded-lg p-6 border border-stone-800',
              children: [
                w.jsx('h4', {
                ...
                w.jsx('ul', {
                  className:
                    'grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-2 text-stone-400',
                  children: t.map((n, r) =>
                    w.jsxs(
                      'li',
                      {
  ...
  Pw = () => {
    const e = [
      {
        title: 'UPI/Bank Statement Analysis Tool',
        description:
          'UPI & Bank Statement Analysis Tool – Full-stack app that parses UPI/bank PDF statements, processes 1000+ transactions with FastAPI and Pandas, and visualizes spending trends and insights via an interactive React.js dashboard.',
        technologies: ['Python', 'FastAPI', 'React.js', 'Pandas'],
        image: 'ScreenShots/bank-statement.png',
        link: 'https://github.com/surajj04/UPI-Pe-Charcha'
      },
      {
        title: 'LinkedIn Profile Miner',
        description:
          'A Python-based tool that automates LinkedIn login, scrapes profile details like education, experience, and skills using Selenium and BeautifulSoup, cleans and processes the data with pandas, and supports CSV/JSON export for analysis.',
        technologies: ['Python', 'Selenium', 'BeautifulSoup', 'pandas'],
        image: 'ScreenShots/linkedin.png',
        link: 'https://github.com/surajj04/LinkedInProfileMiner'
      },
      {
                    ...
                    children: [
                      w.jsx('div', {
                        ...
                        children: w.jsx(O.div, {
                          ...
                          className:
                            'overflow-hidden rounded-xl shadow-lg border border-stone-800 hover:shadow-indigo-500/10 transition-all',
                          children: w.jsx('img', {
                            src: t.image,
                            alt: t.title,
                            className:
                        ...
                        children: [
                          w.jsxs('div', {
                            ...
                            children: [
                              w.jsx(O.h3, {
                                className:
                                  'text-2xl md:text-3xl font-bold text-stone-100',
                                whileHover: { x: 5 },
                            ...
                            children: t.technologies.map((r, i) =>
                              w.jsx(
                                O.span,
                                {
                                  ...
                                  className:
                                    'inline-block px-3 py-1 rounded-full text-sm font-medium bg-stone-800 text-stone-200 hover:bg-indigo-900/50 hover:text-indigo-300 transition-colors',
                                  children: r
                                },
                                i
                              )
        ...
        tags: [
          {
            text: 'CGPA: 7.60',
            bg: 'bg-stone-100',
            darkBg: 'dark:bg-stone-800/80',
            textColor: 'text-stone-700',
            darkTextColor: 'dark:text-stone-200'
          },
          {
            text: 'Degree Awarded',
            bg: 'bg-indigo-100',
            ...
            w.jsxs('div', {
              ...
              children: [
                w.jsx(O.div, {
                  ...
                  viewport: { once: !0 },
                  className:
                    'absolute left-1/4 h-full w-0.5 bg-gradient-to-b from-indigo-900/20 via-indigo-500 to-indigo-900/20 origin-top'
                }),
                w.jsx(O.div, {
                  variants: kw,
                  initial: 'hidden',
                      ...
                      O.div,
                      {
                        ...
                        children: [
                            ...
                            children: w.jsxs('div', {
                              ...
                              children: [
                                w.jsx(O.div, {
                                  variants: Cw,
                                  className:
                                    'w-4 h-4 rounded-full bg-indigo-500 border-2 border-indigo-300 shadow-lg shadow-indigo-500/20 flex-shrink-0'
                                }),
                                w.jsx(O.p, {
                                  className:
                                    'ml-4 text-sm md:text-base text-indigo-300 font-medium',
                                  initial: { opacity: 0 },
                                  whileInView: { opacity: 1 },
                                  transition: { delay: 0.3 },
                                  viewport: { once: !0 },
                          ...
                          w.jsxs(O.div, {
                            ...
                            transition: { type: 'spring', stiffness: 300 },
                            className:
                              'w-full lg:w-3/4 bg-stone-900/50 backdrop-blur-sm rounded-xl p-6 border border-stone-800 shadow-sm hover:shadow-md transition-all duration-300',
                            children: [
                              w.jsxs('h3', {
                                className:
                                  'text-xl md:text-2xl font-bold text-stone-100 mb-1',
                                children: [
                                  t.title,
                                  t.company &&
                                    w.jsx('span', {
                                      className: 'text-indigo-400 text-lg ml-2',
                                      children: t.company
                                    })
                                ]
                              }),
                              t.subtitle &&
                                w.jsx('p', {
                                  className: 'text-stone-400 italic mb-3',
                                  children: t.subtitle
                                }),
                              t.description &&
                                w.jsx('p', {
                                ...
                                children: t.tags.map((r, i) =>
                                  w.jsx(
                                    O.span,
                                    {
                                      ...
                                      className: `inline-block px-3 py-1 rounded-full text-sm font-medium ${r.darkBg} ${r.darkTextColor} border border-stone-700 transition-colors`,
                                      children: r.text
                                    },
                                    i
                                  )
